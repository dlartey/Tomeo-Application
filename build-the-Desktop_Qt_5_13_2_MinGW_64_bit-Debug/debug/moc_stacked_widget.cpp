/****************************************************************************
** Meta object code from reading C++ file 'stacked_widget.h'
**
...
#include <memory>
#include "../../code/stacked_widget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'stacked_widget.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 14, 12), // "changeIndex1"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 12), // "changeIndex2"
QT_MOC_LITERAL(4, 41, 10) // "light_mode"

    },
    "StackedWidget\0changeIndex1\0\0changeIndex2\0"
    "light_mode"
};
...
void StackedWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changeIndex1(); break;
        case 1: _t->changeIndex2(); break;
        case 2: _t->light_mode(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
